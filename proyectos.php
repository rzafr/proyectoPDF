...
?>
                ...
                <?php
                    ...
                    if (!isset($_SESSION['proyectos'])) {
                        ...
                        $proyectos = array(
                            ...
                            array("id" => 3, "nombre" => "Renovacion de equipos", "fechaInicio" => "2022-10-01", "fechaFinPrevista" => "2022-11-11", "diasTranscurridos" => 20, "porcentajeCompletado" => 50, "importancia" => 4),
                            ...
                            array("id" => 5, "nombre" => "Implementacion de la aplicacion", "fechaInicio" => "2022-11-21", "fechaFinPrevista" => "2022-12-21", "diasTranscurridos" => 0, "porcentajeCompletado" => 0, "importancia" => 2),
                            array("id" => 6, "nombre" => "Revision de objetivos", "fechaInicio" => "2022-08-01", "fechaFinPrevista" => "2022-11-30", "diasTranscurridos" => 40, "porcentajeCompletado" => 70, "importancia" => 3)
                            );   
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Proyectos para visualizar en PHP</h1>
